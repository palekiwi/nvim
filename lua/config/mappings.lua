...
local base = {
  ...
  { "<A-Left>",   "<cmd>lfirst<cr>",                                                         desc = "[Loclist] First" },
  { "<A-Up>",     "<cmd>lprev<cr>",                                                          desc = "[Loclist] Prev" },
  { "<A-Down>",   "<cmd>lnext<cr>",                                                          desc = "[Loclist] Next" },
  ...
  { "<space>et",  telescope_utils.search_tags,                                               desc = "String Grep" },
  ...
  { "<leader>h",  "<cmd>Gitsigns preview_hunk_inline<cr>",                                   desc = "Git: Preview inline" },
  ...
  { "th",         "<cmd>Gitsigns preview_hunk_inline<cr><cmd>Gitsigns toggle_word_diff<cr>", desc = "Deleted" },
  ...
  { "tv",         function() git_utils.diffthis(true) end,                                   desc = "Diff this: vertical" },
