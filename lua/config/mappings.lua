...
local base = {
  ...
  { "<leader>fn",      "<cmd>only<cr>",                                                        desc = "Only" },
  { "<leader>g",       group = "[Git]" },
  ...
  { "<leader>gs",      "<cmd>Telescope current_buffer_tags show_line=true<cr>",                desc = "Tags" },
  { "<leader>gt",      telescope_utils.search_tags,                                            desc = "Search tags" },
